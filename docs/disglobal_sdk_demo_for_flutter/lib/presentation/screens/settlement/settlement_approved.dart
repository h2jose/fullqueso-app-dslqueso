...
class SettlementApproved extends StatelessWidget {
  final SettlementResponse settlementResponse;
  const SettlementApproved({super.key, required this.settlementResponse});

  @override
  Widget build(BuildContext context) {
    final colors = Theme.of(context).colorScheme;
    // Convertimos el SettlementResponse a JSON
    final jsonPretty = const JsonEncoder.withIndent(
      '  ',
    ).convert(settlementResponse.toJson());

    return CustomScaffold(
      title: 'RESULTADO DE CIERRE',
      body: Padding(
